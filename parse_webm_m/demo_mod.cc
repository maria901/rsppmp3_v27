...
class DemoCallback : public Callback {
 public:
  ...
  void PrintMandatoryElement(const std::string& name,
   ...
   // std::cout << std::string(indent * spaces_per_indent, ' ') << name;
	...
	if (!element.is_present()) {
      std::cout << " m PrintMandatoryElement (implicit)";
    }
    std::cout << ": m " << element.value() << '\n';
	*/
  }
  ...
  void PrintOptionalElement(const std::string& name,
                            const Element<T>& element) {
    if (element.is_present()) {
      std::cout << std::string(indent * spaces_per_indent, ' ') << name << ": PrintOptionalElement v "
                << element.value() << '\n';
    }
  }
  ...
  template <typename T>
  void PrintOptionalElement(int ricardinho, const std::string& name,
                            const Element<T>& element) {
    if (element.is_present()) {
      std::cout << std::string(indent * spaces_per_indent, ' ') << name << ": PrintOptionalElement v "
                << element.value() << '\n';
  ...
  void PrintMasterElement(const std::string& name, const Element<T>& element) {
    if (element.is_present()) {
      std::cout << std::string(indent * spaces_per_indent, ' ') << name << " j \n";
      ++indent;
  ...
  void PrintValue(const std::string& name, const T& value) {
    //std::cout << std::string(indent * spaces_per_indent, ' ') << name << ": PrintValue p "
              //<< value << '\n';
  }
