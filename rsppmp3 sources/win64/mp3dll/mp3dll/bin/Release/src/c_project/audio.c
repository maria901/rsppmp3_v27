	...
	{
		{
			...
			aufile->sndfile = _wfopen (utf8towide_fixed (ul_______,infile), L"wb");
			free(ul_______);
		}
...
int
write_audio_file (audio_file * aufile, void *sample_buffer, int samples,
                  int offset)
{
...
void
close_audio_file (audio_file * aufile)
{
