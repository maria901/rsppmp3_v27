...
//modified december 04 17:14:35 by ricardo from BinaryWork Corp. http://nomade.sourceforge.net
void
pedro_dprintf
(
	int amanda_level,
...
static unsigned char amanda_e_ricardo_device_lost; 
...
D3D_CreateTexture(SDL_Renderer * renderer, SDL_Texture * texture)
{
	...
	amanda_e_ricardo_device_lost = 0;
...
unsigned char get_device_lost_state_k()
{
	return amanda_e_ricardo_device_lost;
}
static void
D3D_RenderPresent(SDL_Renderer * renderer)
{
    ...
    if (result == D3DERR_DEVICELOST) {
		...
		pedro_dprintf(-1, "kkkkkk te amo...");
		
		amanda_e_ricardo_device_lost = 1;
