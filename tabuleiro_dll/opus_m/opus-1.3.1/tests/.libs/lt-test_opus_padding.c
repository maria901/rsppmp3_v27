...
/* tests/.libs/lt-test_opus_padding.c - temporary wrapper executable for .libs/test_opus_padding.exe
   Generated by libtool (GNU libtool) 2.4.6

   The tests/test_opus_padding program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "C:/AMANDA AVA KOCI PEREIRA/nosso_trabalho/amanda_projects/project tabuleiro/opus-1.3.1/.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "C:/AMANDA;AVA;KOCI;PEREIRA/nosso_trabalho/amanda_projects/project;tabuleiro/opus-1.3.1/.libs;C:/cygwin64_amandaricardo_koci_10.2.0/usr/local/lib;C:/cygwin64_amandaricardo_koci_10.2.0/usr/local/bin;";
const char * TARGET_PROGRAM_NAME = "test_opus_padding.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# tests/test_opus_padding - temporary wrapper script for .libs/test_opus_paddin", f);
  fputs ("g.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The tests/test_opus_padding program cannot be directly executed until all the", f);
  fputs (" libtool\n", f);
  ...
  fputs ("    echo \"test_opus_padding.exe:tests/test_opus_padding:$LINENO: libtool wrappe", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_opus_padding.exe:tests/test_opus_padding:$LINENO: newargv[$lt_d", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_opus_padding.exe:tests/test_opus_padding:$LINENO: newargv[0", f);
  ...
  fputs ("\n", f);
  fputs ("  program='test_opus_padding.exe'\n", f);
