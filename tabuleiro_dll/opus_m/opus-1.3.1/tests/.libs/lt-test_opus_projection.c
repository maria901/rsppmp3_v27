...
/* tests/.libs/lt-test_opus_projection.c - temporary wrapper executable for .libs/test_opus_projection.exe
   Generated by libtool (GNU libtool) 2.4.6

   The tests/test_opus_projection program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "test_opus_projection.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# tests/test_opus_projection - temporary wrapper script for .libs/test_opus_pro", f);
  fputs ("jection.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The tests/test_opus_projection program cannot be directly executed until all ", f);
  fputs ("the libtool\n", f);
  ...
  fputs ("    echo \"test_opus_projection.exe:tests/test_opus_projection:$LINENO: libtool ", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_opus_projection.exe:tests/test_opus_projection:$LINENO: newargv", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_opus_projection.exe:tests/test_opus_projection:$LINENO: new", f);
  ...
  fputs ("\n", f);
  fputs ("  program='test_opus_projection.exe'\n", f);
