...
/* tests/.libs/lt-test_opus_api.c - temporary wrapper executable for .libs/test_opus_api.exe
...
const char * TARGET_PROGRAM_NAME = "test_opus_api.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# tests/test_opus_api - temporary wrapper script for .libs/test_opus_api.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The tests/test_opus_api program cannot be directly executed until all the lib", f);
  fputs ("tool\n", f);
  ...
  fputs ("    echo \"test_opus_api.exe:tests/test_opus_api:$LINENO: libtool wrapper (GNU l", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_opus_api.exe:tests/test_opus_api:$LINENO: newargv[$lt_dump_args", f);
  fputs ("_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_opus_api.exe:tests/test_opus_api:$LINENO: newargv[0]: $prog", f);
  ...
  fputs ("\n", f);
  fputs ("  program='test_opus_api.exe'\n", f);
