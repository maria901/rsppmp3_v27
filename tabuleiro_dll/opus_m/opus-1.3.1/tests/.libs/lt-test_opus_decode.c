...
/* tests/.libs/lt-test_opus_decode.c - temporary wrapper executable for .libs/test_opus_decode.exe
   Generated by libtool (GNU libtool) 2.4.6

   The tests/test_opus_decode program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "test_opus_decode.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# tests/test_opus_decode - temporary wrapper script for .libs/test_opus_decode.", f);
  fputs ("exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The tests/test_opus_decode program cannot be directly executed until all the ", f);
  fputs ("libtool\n", f);
  ...
  fputs ("    echo \"test_opus_decode.exe:tests/test_opus_decode:$LINENO: libtool wrapper ", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_opus_decode.exe:tests/test_opus_decode:$LINENO: newargv[$lt_dum", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_opus_decode.exe:tests/test_opus_decode:$LINENO: newargv[0]:", f);
  ...
  fputs ("\n", f);
  fputs ("  program='test_opus_decode.exe'\n", f);
