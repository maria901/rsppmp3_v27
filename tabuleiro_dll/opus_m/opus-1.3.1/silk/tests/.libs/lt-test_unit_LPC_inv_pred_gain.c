...
/* silk/tests/.libs/lt-test_unit_LPC_inv_pred_gain.c - temporary wrapper executable for .libs/test_unit_LPC_inv_pred_gain.exe
   Generated by libtool (GNU libtool) 2.4.6

   The silk/tests/test_unit_LPC_inv_pred_gain program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "test_unit_LPC_inv_pred_gain.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# silk/tests/test_unit_LPC_inv_pred_gain - temporary wrapper script for .libs/t", f);
  fputs ("est_unit_LPC_inv_pred_gain.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The silk/tests/test_unit_LPC_inv_pred_gain program cannot be directly execute", f);
  fputs ("d until all the libtool\n", f);
  ...
  fputs ("    echo \"test_unit_LPC_inv_pred_gain.exe:silk/tests/test_unit_LPC_inv_pred_gai", f);
  fputs ("n:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_unit_LPC_inv_pred_gain.exe:silk/tests/test_unit_LPC_inv_pred_ga", f);
  fputs ("in:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_unit_LPC_inv_pred_gain.exe:silk/tests/test_unit_LPC_inv_pre", f);
  fputs ("d_gain:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='test_unit_LPC_inv_pred_gain.exe'\n", f);
