...
/* celt/tests/.libs/lt-test_unit_mathops.c - temporary wrapper executable for .libs/test_unit_mathops.exe
   Generated by libtool (GNU libtool) 2.4.6

   The celt/tests/test_unit_mathops program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "test_unit_mathops.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# celt/tests/test_unit_mathops - temporary wrapper script for .libs/test_unit_m", f);
  fputs ("athops.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The celt/tests/test_unit_mathops program cannot be directly executed until al", f);
  fputs ("l the libtool\n", f);
  ...
  fputs ("    echo \"test_unit_mathops.exe:celt/tests/test_unit_mathops:$LINENO: libtool w", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_unit_mathops.exe:celt/tests/test_unit_mathops:$LINENO: newargv[", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_unit_mathops.exe:celt/tests/test_unit_mathops:$LINENO: newa", f);
  ...
  fputs ("\n", f);
  fputs ("  program='test_unit_mathops.exe'\n", f);
