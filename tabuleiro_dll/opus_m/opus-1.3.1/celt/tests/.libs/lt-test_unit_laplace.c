...
/* celt/tests/.libs/lt-test_unit_laplace.c - temporary wrapper executable for .libs/test_unit_laplace.exe
   Generated by libtool (GNU libtool) 2.4.6

   The celt/tests/test_unit_laplace program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "test_unit_laplace.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# celt/tests/test_unit_laplace - temporary wrapper script for .libs/test_unit_l", f);
  fputs ("aplace.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The celt/tests/test_unit_laplace program cannot be directly executed until al", f);
  fputs ("l the libtool\n", f);
  ...
  fputs ("    echo \"test_unit_laplace.exe:celt/tests/test_unit_laplace:$LINENO: libtool w", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_unit_laplace.exe:celt/tests/test_unit_laplace:$LINENO: newargv[", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_unit_laplace.exe:celt/tests/test_unit_laplace:$LINENO: newa", f);
  ...
  fputs ("\n", f);
  fputs ("  program='test_unit_laplace.exe'\n", f);
