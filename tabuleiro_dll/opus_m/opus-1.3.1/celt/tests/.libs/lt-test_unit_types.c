...
/* celt/tests/.libs/lt-test_unit_types.c - temporary wrapper executable for .libs/test_unit_types.exe
   Generated by libtool (GNU libtool) 2.4.6

   The celt/tests/test_unit_types program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "test_unit_types.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# celt/tests/test_unit_types - temporary wrapper script for .libs/test_unit_typ", f);
  fputs ("es.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The celt/tests/test_unit_types program cannot be directly executed until all ", f);
  fputs ("the libtool\n", f);
  ...
  fputs ("    echo \"test_unit_types.exe:celt/tests/test_unit_types:$LINENO: libtool wrapp", f);
  fputs ("er (GNU libtool) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_unit_types.exe:celt/tests/test_unit_types:$LINENO: newargv[$lt_", f);
  fputs ("dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_unit_types.exe:celt/tests/test_unit_types:$LINENO: newargv[", f);
  ...
  fputs ("\n", f);
  fputs ("  program='test_unit_types.exe'\n", f);
