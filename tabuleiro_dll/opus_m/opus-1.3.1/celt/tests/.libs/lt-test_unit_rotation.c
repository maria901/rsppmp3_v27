...
/* celt/tests/.libs/lt-test_unit_rotation.c - temporary wrapper executable for .libs/test_unit_rotation.exe
   Generated by libtool (GNU libtool) 2.4.6

   The celt/tests/test_unit_rotation program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "test_unit_rotation.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# celt/tests/test_unit_rotation - temporary wrapper script for .libs/test_unit_", f);
  fputs ("rotation.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The celt/tests/test_unit_rotation program cannot be directly executed until a", f);
  fputs ("ll the libtool\n", f);
  ...
  fputs ("    echo \"test_unit_rotation.exe:celt/tests/test_unit_rotation:$LINENO: libtool", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_unit_rotation.exe:celt/tests/test_unit_rotation:$LINENO: newarg", f);
  fputs ("v[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_unit_rotation.exe:celt/tests/test_unit_rotation:$LINENO: ne", f);
  fputs ("wargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='test_unit_rotation.exe'\n", f);
