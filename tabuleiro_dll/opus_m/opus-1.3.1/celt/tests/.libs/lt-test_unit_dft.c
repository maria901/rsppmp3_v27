...
/* celt/tests/.libs/lt-test_unit_dft.c - temporary wrapper executable for .libs/test_unit_dft.exe
   Generated by libtool (GNU libtool) 2.4.6

   The celt/tests/test_unit_dft program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "test_unit_dft.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# celt/tests/test_unit_dft - temporary wrapper script for .libs/test_unit_dft.e", f);
  fputs ("xe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The celt/tests/test_unit_dft program cannot be directly executed until all th", f);
  fputs ("e libtool\n", f);
  ...
  fputs ("    echo \"test_unit_dft.exe:celt/tests/test_unit_dft:$LINENO: libtool wrapper (", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_unit_dft.exe:celt/tests/test_unit_dft:$LINENO: newargv[$lt_dump", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_unit_dft.exe:celt/tests/test_unit_dft:$LINENO: newargv[0]: ", f);
  ...
  fputs ("\n", f);
  fputs ("  program='test_unit_dft.exe'\n", f);
