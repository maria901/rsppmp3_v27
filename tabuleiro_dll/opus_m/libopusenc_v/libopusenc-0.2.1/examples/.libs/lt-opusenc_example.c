...
/* examples/.libs/lt-opusenc_example.c - temporary wrapper executable for .libs/opusenc_example.exe
   Generated by libtool (GNU libtool) 2.4.6

   The examples/opusenc_example program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "C:/AMANDA AVA KOCI PEREIRA/nosso_trabalho/amanda_projects/project tabuleiro/libopusenc_v/libopusenc-0.2.1/.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "C:/AMANDA;AVA;KOCI;PEREIRA/nosso_trabalho/amanda_projects/project;tabuleiro/libopusenc_v/libopusenc-0.2.1/.libs;C:/cygwin64_amandaricardo_koci_10.2.0/usr/local/lib;C:/cygwin64_amandaricardo_koci_10.2.0/usr/local/bin;";
const char * TARGET_PROGRAM_NAME = "opusenc_example.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# examples/opusenc_example - temporary wrapper script for .libs/opusenc_example", f);
  fputs (".exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The examples/opusenc_example program cannot be directly executed until all th", f);
  fputs ("e libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' libopusenc.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"opusenc_example.exe:examples/opusenc_example:$LINENO: libtool wrapper", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"opusenc_example.exe:examples/opusenc_example:$LINENO: newargv[$lt_du", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"opusenc_example.exe:examples/opusenc_example:$LINENO: newargv[0]", f);
  ...
  fputs ("\n", f);
  fputs ("  program='opusenc_example.exe'\n", f);
  ...
  fputs ("    PATH=/cygdrive/c/AMANDA:AVA:KOCI:PEREIRA/nosso_trabalho/amanda_projects/pro", f);
  fputs ("ject:tabuleiro/libopusenc_v/libopusenc-0.2.1/.libs:/usr/local/lib:/usr/local/bi", f);
  fputs ("n:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/cygdrive/c/AMANDA AVA KOCI PEREIRA/nosso_trabalho/amanda_projects/pr", f);
  fputs ("oject tabuleiro/libopusenc_v/libopusenc-0.2.1/.libs:$PATH\"\n", f);
  fputs ("\n", f);
