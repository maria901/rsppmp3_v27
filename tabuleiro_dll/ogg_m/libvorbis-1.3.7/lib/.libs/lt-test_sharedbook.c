...
main (int argc, char *argv[])
{
  ...
  lt_debugprintf (__FILE__, __LINE__, "libtool wrapper (GNU libtool) 2.4.6 Debian-2.4.6-14\n");
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# test_sharedbook - temporary wrapper script for .libs/test_sharedbook.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-14\n", f);
  fputs ("#\n", f);
  fputs ("# The test_sharedbook program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"test_sharedbook.exe:test_sharedbook:$LINENO: libtool wrapper (GNU lib", f);
  fputs ("tool) 2.4.6 Debian-2.4.6-14\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_sharedbook.exe:test_sharedbook:$LINENO: newargv[$lt_dump_args_N", f);
  fputs ("]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_sharedbook.exe:test_sharedbook:$LINENO: newargv[0]: $progdi", f);
  fputs ("r/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='test_sharedbook.exe'\n", f);
