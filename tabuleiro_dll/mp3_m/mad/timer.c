 ...
 */
int
mad_timer_compare (mad_timer_t timer1, mad_timer_t timer2)
{
  signed long diff;
 ...
 */
void
mad_timer_negate (mad_timer_t * timer)
{
 ...
 */
mad_timer_t
mad_timer_abs (mad_timer_t timer)
{
  if (timer.seconds < 0)
 ...
 */
static void
reduce_timer (mad_timer_t * timer)
{
...
gcd (unsigned long num1, unsigned long num2)
{
  unsigned long tmp;
 ...
 */
static void
reduce_rational (unsigned long *numer, unsigned long *denom)
{
 ...
 */
static unsigned long
scale_rational (unsigned long numer, unsigned long denom, unsigned long scale)
{
 ...
 */
void
mad_timer_set (mad_timer_t * timer, unsigned long seconds,
 ...
 */
void
mad_timer_add (mad_timer_t * timer, mad_timer_t incr)
{
 ...
 */
void
mad_timer_multiply (mad_timer_t * timer, signed long scalar)
{
  mad_timer_t addend;
  unsigned long factor;
 ...
 */
signed long
mad_timer_count (mad_timer_t timer, enum mad_units units)
{
  switch (units)
    {
 ...
 */
unsigned long
mad_timer_fraction (mad_timer_t timer, unsigned long denom)
{
 ...
 */
void
mad_timer_string (mad_timer_t timer,
		  ...
		  enum mad_units fracunits, unsigned long subparts)
{
  ...
  switch (units)
    ...
    case MAD_UNITS_MINUTES:
      ...
      sprintf (dest, format,
	       minutes, (unsigned int) (seconds % 60), frac, sub);
      break;
