...
namespace mp3dll
{
	partial class sample
	{
		...
		private void InitializeComponent()
		{
			...
			this.enable_sc_hack = new System.Windows.Forms.CheckBox();
			this.koci_timer = new System.Windows.Forms.Timer(this.components);
			this.create_z = new System.Windows.Forms.Button();
			this.label20 = new System.Windows.Forms.Label();
			this.bugfix_fullscreen_z = new System.Windows.Forms.PictureBox();
			this.progressbar_27_51_z_v21 = new amanda_progress.progressbar();
			...
			((System.ComponentModel.ISupportInitialize)(this.bugfix_fullscreen_z)).BeginInit();
			this.SuspendLayout();
			// 
			// main_timer
			// 
			...
			// of1
			// 
			this.of1.Title = "Morcego diz abre-te Sésamo";
			// 
			// label2
			// 
			...
			this.filetowav.Text = "Z:/Ava/back/amanda_ava_pereira___net_out.wav";
			// 
			// morcego_error
			// 
			...
			this.by_BW.Location = new System.Drawing.Point(425, 639);
			this.by_BW.Name = "by_BW";
			this.by_BW.Size = new System.Drawing.Size(269, 13);
			this.by_BW.TabIndex = 59;
			this.by_BW.TabStop = true;
			this.by_BW.Text = "BinaryWork Corp. https://arsoftware.net.br/binarywork/";
			...
			this.disable_video.Location = new System.Drawing.Point(376, 465);
			...
			this.no_draw.Location = new System.Drawing.Point(376, 488);
			...
			this.file_l.Click += new System.EventHandler(this.File_lClick);
			// 
			// sync_t
			// 
			...
			this.background_p.Location = new System.Drawing.Point(996, 143);
			...
			// enable_sc_hack
			// 
			this.enable_sc_hack.AutoSize = true;
			this.enable_sc_hack.Location = new System.Drawing.Point(576, 443);
			this.enable_sc_hack.Name = "enable_sc_hack";
			this.enable_sc_hack.Size = new System.Drawing.Size(167, 17);
			this.enable_sc_hack.TabIndex = 132;
			this.enable_sc_hack.Text = "Enable Slow Computers Hack";
			this.enable_sc_hack.UseVisualStyleBackColor = true;
			this.enable_sc_hack.MouseUp += new System.Windows.Forms.MouseEventHandler(this.enable_slow_computer_hack_);
			// 
			// koci_timer
			// 
			this.koci_timer.Interval = 1000;
			this.koci_timer.Tick += new System.EventHandler(this.Koci_timerTick);
			// 
			// create_z
			// 
			this.create_z.Location = new System.Drawing.Point(815, 245);
			this.create_z.Name = "create_z";
			this.create_z.Size = new System.Drawing.Size(82, 20);
			this.create_z.TabIndex = 133;
			this.create_z.Text = "Create";
			this.create_z.UseVisualStyleBackColor = true;
			this.create_z.Click += new System.EventHandler(this.create_Click_1);
			// 
			// label20
			// 
			this.label20.Location = new System.Drawing.Point(19, 488);
			...
			// bugfix_fullscreen_z
			// 
			this.bugfix_fullscreen_z.Location = new System.Drawing.Point(531, 125);
			this.bugfix_fullscreen_z.Name = "bugfix_fullscreen_z";
			this.bugfix_fullscreen_z.Size = new System.Drawing.Size(55, 52);
			this.bugfix_fullscreen_z.TabIndex = 135;
			this.bugfix_fullscreen_z.TabStop = false;
			// 
			// progressbar_27_51_z_v21
			// 
			this.progressbar_27_51_z_v21.Location = new System.Drawing.Point(21, 569);
			this.progressbar_27_51_z_v21.Maximum = 10000;
			this.progressbar_27_51_z_v21.Name = "progressbar_27_51_z_v21";
			this.progressbar_27_51_z_v21.Size = new System.Drawing.Size(669, 28);
			this.progressbar_27_51_z_v21.TabIndex = 136;
			this.progressbar_27_51_z_v21.Value = 0;
			this.progressbar_27_51_z_v21.Mouse += new amanda_progress.progressbar.NewMouseEvent(this.Progressbar_27_51_z_v21Mouse);
			// 
			// fullscreen_fix_p
			// 
			this.fullscreen_fix_p.Location = new System.Drawing.Point(1098, 619);
			this.fullscreen_fix_p.Name = "fullscreen_fix_p";
			this.fullscreen_fix_p.Size = new System.Drawing.Size(164, 41);
			this.fullscreen_fix_p.TabIndex = 137;
			this.fullscreen_fix_p.Text = "Force a hidden taskbar on fullscreen mode";
			this.fullscreen_fix_p.UseVisualStyleBackColor = true;
			// 
			// button2
			// 
			this.button2.Location = new System.Drawing.Point(700, 335);
			this.button2.Name = "button2";
			this.button2.Size = new System.Drawing.Size(77, 20);
			this.button2.TabIndex = 138;
			this.button2.Text = "Float";
			this.button2.UseVisualStyleBackColor = true;
			this.button2.Click += new System.EventHandler(this.Button2Click_amanda);
			// 
			// use_cache_amanda_s_smart_ape
			// 
			...
			// button6
			// 
			this.button6.Location = new System.Drawing.Point(464, 64);
			this.button6.Name = "button6";
			this.button6.Size = new System.Drawing.Size(85, 22);
			this.button6.TabIndex = 148;
			this.button6.Text = "Mode ffplay.c";
			...
			this.Controls.Add(this.create_z);
			this.Controls.Add(this.enable_sc_hack);
			...
			this.Controls.Add(this.bugfix_fullscreen_z);
			...
			this.ResizeEnd += new System.EventHandler(this.SampleResizeEnd);
			...
			((System.ComponentModel.ISupportInitialize)(this.bugfix_fullscreen_z)).EndInit();
		...
		internal System.Windows.Forms.ListBox morcego_error;
		...
		private System.Windows.Forms.CheckBox enable_sc_hack;
		private System.Windows.Forms.Timer koci_timer;
		private System.Windows.Forms.Button create_z;
		private System.Windows.Forms.Label label20;
		private System.Windows.Forms.PictureBox bugfix_fullscreen_z;
		private amanda_progress.progressbar progressbar_27_51_z_v21;
