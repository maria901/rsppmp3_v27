...
#define MAXPATH_UTF_8_MODE_AMANDA_S_SMART_APE (MAX_PATH * 6) /* is it enough or 32767?*/
...
typedef struct morcego_instance_be_
{
     ...
     ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
     // added in 14/oct/2021 02:56

     int64_t libav_c___video_bitrate_m;
     ...
     ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
     // added at 26/dec/2021 21:21:21

     bool libav_c___first_call_rotate_j;
     int32_t *libav_c___rotation_value_m;
...
id3v2tag_multithread(
    ...
    char *filename);
int save_to_file_multithread(
    morcego___i___instance__a__bucaneiro_engineering *mv_______,
    char *infile, char *data, int size,
    int mode, int limit);

int id3v2tag_ok_write_multithread(
    morcego___i___instance__a__bucaneiro_engineering *mv_______,
    char *filename);
int surround2(morcego___i___instance__a__bucaneiro_engineering *mv_______, char *buf, int bytes, int bps, int nch);
int resetwaveeefects(morcego___i___instance__a__bucaneiro_engineering *mv_______);
int echo(morcego___i___instance__a__bucaneiro_engineering *mv_______, char *buf, int bytes, int bps, int nch);
int echofinal(morcego___i___instance__a__bucaneiro_engineering *mv_______, int multiplier, int enableecho, int ponto, char *globalbuf,
...
int v2cleanup(morcego___i___instance__a__bucaneiro_engineering *mv_______);
WCHAR *__stdcall utf8towide_fixed(
    unicode_large *ul_______,
    const char *pUTF8);
char *__stdcall widetoutf8_fixed(
    unicode_large *ul_______,
    WCHAR *pUSC2);
void init_iir(morcego___i___instance__a__bucaneiro_engineering *mv_______);
int iir(morcego___i___instance__a__bucaneiro_engineering *mv_______, char *d, int length, int channels);
int configequalizer____2(morcego___i___instance__a__bucaneiro_engineering *mv_______, int b60, int b170, int b310, int b600, int b1000, int b3000,
                         int b6000, int b12000, int b14000, int b16000);
int iir___2(morcego___i___instance__a__bucaneiro_engineering *mv_______, char *d, int length, int channels);
void init_iir____2(morcego___i___instance__a__bucaneiro_engineering *mv_______);
double
